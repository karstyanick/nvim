...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = function()
      ...
      -- Define your custom header (ASCII art) for the splash screen.
      ...
      for _, language in ipairs(js_based_languages) do
        dap.configurations[language] = {
          ...
          },
          {
            type = 'pwa-node',
            request = 'launch',
            name = 'Debug Jest Integration (current file)',
            runtimeExecutable = 'node',
            runtimeArgs = {
              '${workspaceFolder}/node_modules/.bin/jest',
              '--config',
              '${workspaceFolder}/server/tests/jest.integration.config.js',
              '--runInBand',
              '--no-coverage',
              '${file}',
            },
